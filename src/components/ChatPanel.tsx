        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="font-bold text-green-100 text-sm">
                {chunk.maps.title}
              </div>
            ...
            {msg.groundingMetadata?.groundingChunks &&
              msg.groundingMetadata.groundingChunks.length > 0 && (
                <div className="mt-2 max-w-[85%] w-full">
                  <div className="text-[10px] uppercase tracking-wider text-gray-500 font-bold mb-1.5 ml-1">
                    Sources
                  </div>
