...
const App: React.FC = () => {
  ...
  if (roomId) {
    return (
      <MeetingRoom user={user} roomId={roomId} onLeave={handleLeaveRoom} />
    );
  }
      ...
      <main className="container mx-auto px-6 pt-12 relative z-10 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 max-w-xl">
          ...
          <p className="text-gray-400 text-lg mb-10 leading-relaxed">
            Create a room and collaborate with AI. Use the integrated Gemini
            tools to Search the web and find places on Google Maps directly
            within your meeting chat.
          </p>
